...
#define SYS_PIPC      ( 0x08 )
#define SYS_WRITEPIPE ( 0x09 )
#define SYS_READPIPE  ( 0x0a )
#define SYS_PIPF      ( 0x0b )
...
extern void pipc(pid_t pid1, int s);
extern void writepipe( int fd, int x);
extern int readpipe();
extern int pipeFull(int fd);
